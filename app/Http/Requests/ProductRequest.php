...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
      return [
        ...
        'model_id' => 'required|integer|exists:model_types,id',
        'condition' => 'required|integer|in:1,2',
        'storage_id' => 'required|integer|exists:storages,id',
        'type_of_machine' => 'required|integer',
        'lock_by' => 'nullable|required_if:type_of_machine,4|integer|exists:networks,id',
        'battery_percentage' => 'required|integer',
        'product_percentage' => 'required|integer',
        'purchase_price' => 'required|numeric',
        'selling_price' => 'numeric',
        'purchase_date' => 'required|date',
        'product_status' => 'required|integer|in:1,2,3,4',
